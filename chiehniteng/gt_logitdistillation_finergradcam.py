...
class CFG:
    print_freq=1000
    num_workers = 4
    model_name = 'gt_logitdistillation_finergradcam'
    size = 512
    epochs = 30
    factor = 0.2
    patience = 5
...
if __name__ == '__main__':
    wandb.init(project="VRDL-Final",name="gt_logitdistillation_finergradcam")
    ...
    state_dict = torch.load("./finergradcam_fold0_best_d_d.pth")['model']
    state_dict = remove_module_prefix(state_dict)
    ...
    for epoch in range(CFG.epochs):
        ...
        for step, (images, labels) in enumerate(train_loader):
            ...
            # discriminator
            d_class_logits = discriminator(images.cuda(), cams.cuda())
            ...
            s_loss = alpha * s_class_loss + beta * s_kl_loss
            ...
            del images, labels, cams, d_class_logits, s_class_logits
        ...
        for step, (images, labels) in enumerate(valid_loader):
            ...
            del images, cams, d_class_logits, s_class_logits
